<ul id="menu" class="bg-blue dker">
    ...
    <li><a href="commande.php"><i class="fa fa-file"></i><span class="link-title"> Commandes validées</span></a></li>
	<li><a href="commandearchivee.php"><i class="fa fa-file"></i><span class="link-title"> Commandes archivées</span></a></li>
