...
<html class="no-js">
    <head>
        <meta charset="UTF-8">
        <title>Ajouter un coupon de réduction</title>
        ...
        <div class="bg-dark dk" id="wrap">
            <div id="top">
                ...
                <header class="head">
                    ...
                    <div class="main-bar">
                        <h3>
                            <i class="fa fa-money"></i>&nbsp; Coupon de réduction</h3>
                    </div><!-- /.main-bar -->
                </header><!-- /.head -->
            </div><!-- /#top -->
            <div id="left">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5 style="color: #000">Coupon de réduction</h5>
                                </header>
                                <div id="collapse4" class="body">
                                    <div class="row">
                                        <?php
                                        if (isset($_POST['code'])) {
                                            mysql_query("insert into codepromo(code,montant,datedebut,datefin,etat)values('" . addslashes($_POST['code']) . "','" . addslashes($_POST['montant']) . "','" . addslashes($_POST['dtdeb']) . "','" . addslashes($_POST['dtfin']) . "',1);");
                                            echo '<script>alert("Coupon ajouté !")</script>';
                                            echo '<script>window.location="reduction.php"</script>';
                                        }
                                        ?>
