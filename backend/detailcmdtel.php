...
$client = mysql_fetch_array(mysql_query("select client_tel.nom,client_tel.prenom, chauffeur.nom, chauffeur.prenom as chauff, chauffeur.nom as name, reservation_tel.heure,reservation_tel.depart,client_tel.tel,reservation_tel.arrivee,reservation_tel.id,reservation_tel.dtdeb,reservation_tel.prix from chauffeur, client_tel, reservation_tel where  reservation_tel.client = client_tel.id and chauffeur.id_chauffeur=reservation_tel.id_chauffeur and reservation_tel.id=" . $_GET['id']));
