...
<html class="no-js">
    <head>
        <meta charset="UTF-8">
        <title>Coupon de réduction</title>
        ...
        <div class="bg-dark dk" id="wrap">
            <div id="top">
                ...
                <header class="head">
                    ...
                    <div class="main-bar">
                        <h3>
                            <i class="fa fa-user"></i>&nbsp; Coupons de réduction</h3>
                    </div><!-- /.main-bar -->
                </header><!-- /.head -->
            </div><!-- /#top -->
            <div id="left">
                            ...
                            <div class="col-lg-12">
                                <div class="box">
                                    <header>
                                        ...
                                        <h5><a href="ajoutcoupon.php" class="btn btn-primary">Nouveau coupon de réduction</a></h5>
                                    </header>
                                    <?php
                                    if (isset($_GET['id'])) {
                                        mysql_query("delete from codepromo where id=" . $_GET['id']);
                                        echo "<script>alert('Code supprimé !')</script>";
                                            ...
                                            <tbody>
                                                ...
                                                while ($data = mysql_fetch_array($sql)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="reduction.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-xs">Supprimer</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
