                                    ...
                                    <div id="collapse4" class="body">
                                        <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = mysql_query("select reservation_attente.id, myvtc_users.nom, myvtc_users.prenom,reservation_attente.chauffeur, reservation_attente.heure, reservation_attente.depart,reservation_attente.arrivee,DATE_FORMAT(reservation_attente.dtdeb, '%d/%m/%Y') as dtdeb,reservation_attente.prix from  myvtc_users inner join  reservation_attente on reservation_attente.id_user = myvtc_users.id INNER JOIN sogenactif ON reservation_attente.codecommande=sogenactif.codecommande where sogenactif.response_code=0 AND  reservation_attente.etat=0 and  reservation_attente.archive=0");
