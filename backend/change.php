...
if (isset($_POST['login'])) {
    $login = $_POST['login'];
    $pwd = $_POST['pwd'];
    mysql_query("update users set login='" . $login . "', pwd='" . $pwd . "' where id=1");
}
?>
<!doctype html>
<html class="no-js">
                                    ...
                                    <div id="div-1" class="body">
                                        ...
                                        <form class="form-horizontal" method="post" action="">
                                            ...
                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">Login</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="login" placeholder="Nom d'utilisateur" value="<?php echo $users['login'];  ?>" class="form-control">
                                                </div>
                                            </div><!-- /.form-group -->
                                            <div class="form-group">
                                                <label for="text1" class="control-label col-lg-4">Mot de passe</label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="pwd" placeholder="Mot de passe" value="<?php echo $users['pwd'];  ?>" class="form-control">
                                                </div>
                                            </div><!-- /.form-group -->
                                        </form>
                                    </div>
